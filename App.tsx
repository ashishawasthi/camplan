  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        ...
        return <Step2AudienceSegments campaign={campaign} setCampaign={updateCampaign} onNext={handleNext} onBack={handleBack} setError={setError} />;
      case 3:
        if (!campaign) return null;
      ...
      case 4:
        if (!campaign) return null;
        return <Step4BudgetSplit campaign={campaign} setCampaign={updateCampaign} onNext={handleNext} onBack={handleBack} setError={setError} />;
      case 5:
        if (!campaign) return null;
